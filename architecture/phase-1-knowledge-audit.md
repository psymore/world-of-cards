...
| -------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| Purpose / Quality Attributes (World Cards-specific)                                                                  | `architecture/` (new project-specific doc, sibling to the generic WKA docs)                                                                                                               | Project owner (user)                                                                           | Everyone, once per onboarding                              | Rarely                                                                               |
...
| ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `CLAUDE.md` header sentence (Purpose)                                                                                  | `architecture/world-cards-purpose.md` (new)                                                                                                                                                                                   |
...
- The Purpose statement's _pointer_ (one line, linking out to `architecture/world-cards-purpose.md`), not its full text.
...
- `architecture/world-cards-purpose.md`
